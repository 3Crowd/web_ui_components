...
def dynamic_subclass class_to_subclass = Object, opts = {}
  opts = { :class_location => self.class, :class_prefix => "", :class_suffix => "", :class_identifier => "DynamicClass", :class_unique_id => self.object_id }.merge(opts)
  ...
  opts[:class_location].const_set(class_name, dynamic_anonymous_subclass(class_to_subclass))
end
